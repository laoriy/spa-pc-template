 ...
 * @param callback 验证回调
 */
export const validatePhone = (rule: PlianObj, value: string, callback: CB) => {
...
// 固定电话自定义验证规则
export const validateFixedTelephoneNumber = (rule: PlianObj, value: string, callback: CB) => {
...
// 身份证号 15位或18位
export const validateIdNum = (rule: PlianObj, value: string, callback: CB) => {
...
export const validateWeChat = (rule: PlianObj, value: string, callback: CB) => {
...
// 米聊号
// 一位大写或小写字母开头，后面可以连接5到19位-或_或小写字母或大写字母或数字
export const validateMiChat = (rule: PlianObj, value: string, callback: CB) => {
...
// 邮箱验证规则
export const validateEmial = (rule: PlianObj, value: string, callback: CB) => {
...
// 金额自定义验证规则
export const validatePrice = (rule: PlianObj, value: string, callback: CB) => {
